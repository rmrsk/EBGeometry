...
* `ClosestPointPacked` For closest-point search over a point cloud, forming PointAoSoA-grouped PackedBVH leaves from a per-point TreeBVH via `packWith()`, benchmarked against brute force.
