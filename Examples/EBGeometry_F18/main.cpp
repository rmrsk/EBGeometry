...
main(int argc, char* argv[])
{
  ...
  const auto fastUnionSlowSDF = EBGeometry::BVHUnion<T, SlowSDF, BV, K>(slowSDFs, boundingVolumes);
  const auto fastUnionFastSDF = EBGeometry::BVHUnion<T, FastSDF, BV, K>(fastSDFs, boundingVolumes);
