...
This folder shows the same "many objects in one scene" idea as `EBGeometry_PackedSpheres`, but
...
lattice in `EBGeometry_PackedSpheres` -- finding the nearest building genuinely requires a
