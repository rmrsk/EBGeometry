...
\begin{DoxyCode}{0}
\DoxyCodeLine{=}
\DoxyCodeLine{    [](\textcolor{keyword}{const} \mbox{\hyperlink{classBVH_1_1NodeT}{BVH::NodeT<T, P, BV, K>}}\& a\_node) noexcept -\/> \textcolor{keywordtype}{bool} \{ \textcolor{keywordflow}{return} (a\_node.getPrimitives()).size() < K; \}}
...
{\bfseries Initial value\+:}
\begin{DoxyCode}{0}
\DoxyCodeLine{= [](\textcolor{keyword}{const} std::vector<X>\& a\_primitives) noexcept -\/> std::array<std::vector<X>, K> \{}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{=}
\DoxyCodeLine{    [](\textcolor{keyword}{const} PrimAndBVListT<P, BV>\& a\_primsAndBVs) noexcept -\/> std::array<PrimAndBVListT<P, BV>, K> \{}
\DoxyCodeLine{    \mbox{\hyperlink{classVec3T}{Vec3T<T>}} lo = \mbox{\hyperlink{classVec3T_a151575a04910352d4f8c028fef081d01}{Vec3T<T>::max}}();}
\DoxyCodeLine{    \mbox{\hyperlink{classVec3T}{Vec3T<T>}} hi = -\/\mbox{\hyperlink{classVec3T_a151575a04910352d4f8c028fef081d01}{Vec3T<T>::max}}();}
\DoxyCodeLine{}
\DoxyCodeLine{    \textcolor{keywordflow}{for} (\textcolor{keyword}{const} \textcolor{keyword}{auto}\& pbv : a\_primsAndBVs) \{}
