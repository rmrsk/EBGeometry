...
\item\contentsline{section}{\mbox{\hyperlink{classDifferenceIF}{Difference\+IF$<$ T $>$}} \\*CSG difference between two implicit functions }{\pageref{classDifferenceIF}}{}
\item\contentsline{section}{\mbox{\hyperlink{classDCEL_1_1EdgeIteratorT}{DCEL\+::\+Edge\+Iterator\+T$<$ T, Meta $>$}} \\*Edge iterator class }{\pageref{classDCEL_1_1EdgeIteratorT}}{}
\item\contentsline{section}{\mbox{\hyperlink{classDCEL_1_1EdgeT}{DCEL\+::\+Edge\+T$<$ T, Meta $>$}} \\*Edge class }{\pageref{classDCEL_1_1EdgeT}}{}
\item\contentsline{section}{\mbox{\hyperlink{classElongateIF}{Elongate\+IF$<$ T $>$}} \\*Implicit function which is an elongation of another implicit function along some axis }{\pageref{classElongateIF}}{}
\item\contentsline{section}{\mbox{\hyperlink{classDCEL_1_1FaceT}{DCEL\+::\+Face\+T$<$ T, Meta $>$}} \\*Face class }{\pageref{classDCEL_1_1FaceT}}{}
\item\contentsline{section}{\mbox{\hyperlink{classFastCompactMeshSDF}{Fast\+Compact\+Mesh\+SDF$<$ T, Meta, BV, K $>$}} \\*Signed distance function for a \doxylink{namespaceDCEL}{DCEL} mesh. This class uses the compact \doxylink{namespaceBVH}{BVH} representation }{\pageref{classFastCompactMeshSDF}}{}
\item\contentsline{section}{\mbox{\hyperlink{classFastMeshSDF}{Fast\+Mesh\+SDF$<$ T, Meta, BV, K $>$}} \\*Signed distance function for a \doxylink{namespaceDCEL}{DCEL} mesh. This class uses the full \doxylink{namespaceBVH}{BVH} representation }{\pageref{classFastMeshSDF}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{classFastTriMeshSDF}{Fast\+Tri\+Mesh\+SDF$<$ T, Meta, BV, K $>$}} \\*Signed distance function for a triangle mesh. This class uses the full \doxylink{namespaceBVH}{BVH} representation }{\pageref{classFastTriMeshSDF}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{classFiniteRepetitionIF}{Finite\+Repetition\+IF$<$ T $>$}} \\*Class which creates a periodic repetition of an implicit function }{\pageref{classFiniteRepetitionIF}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{classBVH_1_1LinearBVH}{BVH\+::\+Linear\+BVH$<$ T, P, BV, K $>$}} \\*Forward declare linear \doxylink{namespaceBVH}{BVH} class }{\pageref{classBVH_1_1LinearBVH}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{classMeshSDF}{Mesh\+SDF$<$ T, Meta $>$}} \\*Signed distance function for a \doxylink{namespaceDCEL}{DCEL} mesh. Does not use BVHs }{\pageref{classMeshSDF}}{}
\item\contentsline{section}{\mbox{\hyperlink{classDCEL_1_1MeshT}{DCEL\+::\+Mesh\+T$<$ T, Meta $>$}} \\*Mesh class }{\pageref{classDCEL_1_1MeshT}}{}
\item\contentsline{section}{\mbox{\hyperlink{classMollifyIF}{Mollify\+IF$<$ T $>$}} \\*Mollified implicit function }{\pageref{classMollifyIF}}{}
\item\contentsline{section}{\mbox{\hyperlink{structSFC_1_1Morton}{SFC\+::\+Morton}} \\*Implementation of the \doxylink{structSFC_1_1Morton}{Morton} SFC }{\pageref{structSFC_1_1Morton}}{}
\item\contentsline{section}{\mbox{\hyperlink{structSFC_1_1Nested}{SFC\+::\+Nested}} \\*Implementation of a nested index SFC }{\pageref{structSFC_1_1Nested}}{}
\item\contentsline{section}{\mbox{\hyperlink{classOctree_1_1Node}{Octree\+::\+Node$<$ Meta, Data $>$}} \\*\doxylink{namespaceOctree}{Octree} class without anything special (this uses full tree representation rather than linear/pointerless) }{\pageref{classOctree_1_1Node}}{}
\item\contentsline{section}{\mbox{\hyperlink{classBVH_1_1NodeT}{BVH\+::\+Node\+T$<$ T, P, BV, K $>$}} \\*Forward declare the \doxylink{namespaceBVH}{BVH} node since it is needed for the polymorphic lambdas }{\pageref{classBVH_1_1NodeT}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{classPerlinSDF}{Perlin\+SDF$<$ T $>$}} \\*Ken Perlins gradient noise function }{\pageref{classPerlinSDF}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{classPLY}{PLY$<$ T $>$}} \\*Class for storing Stanford \doxylink{classPLY}{PLY} meshes }{\pageref{classPLY}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{classReflectIF}{Reflect\+IF$<$ T $>$}} \\*Implicit function which is a reflection of another implicit function }{\pageref{classReflectIF}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{classRoundedBoxSDF}{Rounded\+Box\+SDF$<$ T $>$}} \\*Box of arbitrary dimensions centered at the origin, with rounded corners }{\pageref{classRoundedBoxSDF}}{}
\item\contentsline{section}{\mbox{\hyperlink{classRoundedCylinderSDF}{Rounded\+Cylinder\+SDF$<$ T $>$}} \\*Rounded cylinder signed-\/distance function }{\pageref{classRoundedCylinderSDF}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{classEBGeometry_1_1SimpleTimer}{EBGeometry\+::\+Simple\+Timer}} \\*Simple timer class used for local performance profiling. Does not include MPI capabilities and is therefore local to each rank }{\pageref{classEBGeometry_1_1SimpleTimer}}{}
\item\contentsline{section}{\mbox{\hyperlink{classSmoothDifferenceIF}{Smooth\+Difference\+IF$<$ T $>$}} \\*CSG difference between two implicit functions }{\pageref{classSmoothDifferenceIF}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{classSTL}{STL$<$ T $>$}} \\*Class for storing contents of \doxylink{classSTL}{STL} files }{\pageref{classSTL}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{classEBGeometry_1_1Triangle}{EBGeometry\+::\+Triangle$<$ T, Meta $>$}} \\*\doxylink{classEBGeometry_1_1Triangle}{Triangle} class with signed distance functionality }{\pageref{classEBGeometry_1_1Triangle}}{}
...
\item\contentsline{section}{\mbox{\hyperlink{classDCEL_1_1VertexT}{DCEL\+::\+Vertex\+T$<$ T, Meta $>$}} \\*Vertex class }{\pageref{classDCEL_1_1VertexT}}{}
\item\contentsline{section}{\mbox{\hyperlink{classVTK}{VTK$<$ T $>$}} \\*Class for storing \doxylink{classVTK}{VTK} Polydata meshes }{\pageref{classVTK}}{}
\end{DoxyCompactList}
