...
template <class T>
inline MeshT<T>::MeshT(std::vector<FacePtr>& a_faces, std::vector<EdgePtr>& a_edges, std::vector<VertexPtr>& a_vertices)
  : MeshT()
{
...
inline void
MeshT<T>::define(
  std::vector<FacePtr>& a_faces, std::vector<EdgePtr>& a_edges, std::vector<VertexPtr>& a_vertices) noexcept
{
  m_faces = a_faces;
  m_edges = a_edges;
...
MeshT<T>::sanityCheck() const noexcept
{
  ...
  std::map<std::string, size_t> warnings = {{f_null, 0},       {f_noEdge, 0},     {f_degenerate, 0}, {e_null, 0},
                                            {e_degenerate, 0}, {e_noPairEdge, 0}, {e_noNextEdge, 0}, {e_noPrevEdge, 0},
                                            {e_noOrigVert, 0}, {e_noFace, 0},     {e_noPrevNext, 0}, {e_noNextPrev, 0},
                                            {v_null, 0},       {v_noEdge, 0}};
