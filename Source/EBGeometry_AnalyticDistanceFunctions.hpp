...
/*!
  @brief Clamp function. Returns lo if v < lo and hi if v > hi. Otherwise returns v. 
...
/*!
  ...
  @details Rounded distance function -- returns the original distance function displaced by the specified rounding radius.
...
/*!
  @brief Capsulate/pill SDF. Basically a cylinder with spherical endcaps, oriented along the specified axis.
*/
template <class T>
