...
template <class T>
inline FaceT<T>::FaceT(const EdgePtr& a_edge) : Face()
{
  m_halfEdge = a_edge;
}

template <class T>
inline FaceT<T>::FaceT(const Face& a_otherFace) : Face()
{
...
template <class T>
inline void
FaceT<T>::define(const Vec3& a_normal, const EdgePtr& a_edge) noexcept
{
  m_normal = a_normal;
  m_halfEdge = a_edge;
}
...
template <class T>
inline void
FaceT<T>::setHalfEdge(const EdgePtr& a_halfEdge) noexcept
{
...
template <class T>
inline void
FaceT<T>::computeCentroid() noexcept
{
...
template <class T>
inline void
FaceT<T>::computeNormal() noexcept
{
  const auto vertices = this->gatherVertices();
...
FaceT<T>::getHalfEdge() const noexcept
{
  return (m_halfEdge);
}
...
FaceT<T>::gatherVertices() const noexcept
{
...
FaceT<T>::getAllVertexCoordinates() const noexcept
{
  std::vector<Vec3> ret;
...
template <class T>
inline Vec3T<T>
FaceT<T>::getSmallestCoordinate() const noexcept
{
...
template <class T>
inline Vec3T<T>
FaceT<T>::getHighestCoordinate() const noexcept
{
  const auto coords = this->getAllVertexCoordinates();
...
template <class T>
inline bool
FaceT<T>::isPointInsideFace(const Vec3& a_p) const noexcept
{
...
template <class T>
inline T
FaceT<T>::signedDistance(const Vec3& a_x0) const noexcept
{
...
template <class T>
inline T
FaceT<T>::unsignedDistance2(const Vec3& a_x0) const noexcept
{
  T retval = std::numeric_limits<T>::infinity();
