...
/*!
  ...
  @brief  Declaration of 2D and 3D point/vector classes with templated precision. Used with DCEL tools. 
...
/*!
  ...
  @details The class has a public-only interface. To change it's components one can call the member functions, or set components directly, e.g. vec.x = 5.0
...
public:
  ...
  */
  ...
  /*!
    ...
    @param[in] a_other Other vector
    @details Returns a new object with component x = this->x + a_other.x (same for y-component)
  */
  inline
  ...
  */
  ...
  /*!
    ...
    @details Returns a new Vec2T<T> with components x = s*this->x (and same for y)
  */
  inline
  ...
  /*!
    ...
    @param[in] s Scalar to be multiplied
    @details Returns a new Vec2T<T> with components x = (1/s)*this->x (and same for y)
  */
  inline
  Vec2T<T> operator/(const T& s) const noexcept;
  ...
  /*!
    ...
    @details Returns (*this) with components this->x = this->x + a_other.x (and same for y)
  */
  inline
  Vec2T<T>& operator+=(const Vec2T& a_other) noexcept;
  ...
  */  
  ...
  /*!
    ...
    @details Returns (*this) with components this->x = s*this->x (and same for y)
  */  
  inline
  ...
  /*!
    ...
    @details Returns (*this) with components this->x = (1/s)*this->x (and same for y)
  */  
  inline
  Vec2T<T>& operator/=(const T& s) noexcept;
  ...
  */    
  ...
  /*!
    ...
    @return Returns length of vector, i.e. sqrt[(this->x)*(this->x) + (this->y)*(this->y)]
  */
  inline
  ...
  /*!
    ...
    @return Returns length of vector, i.e. (this->x)*(this->x) + (this->y)*(this->y)
  */
  inline
...
/*!
  ...
  @details The class has a public-only interface. To change it's components one can call the member functions, or set components directly, e.g. vec.x = 5.0
  @note Vec3T is a templated class primarily used with DCEL grids. It is always 3D, i.e. independent of Chombo configuration settings. This lets one use DCEL 
...
public:
  ...
  */
  ...
  /*!
    ...
    @details Returns true if this->x < u.x AND this->y < u.y AND this->z < u.z and false otherwise
    @param[in] u Other vector
  */
  inline
  bool operator<(const Vec3T<T>& u) const noexcept;
  ...
  */
  ...
  /*!
    @brief Assignment operator. Sets components equal to the argument vector's components
    @param[in] u Other vector
  */
  inline
  ...
  */
  ...
  /*!
    @brief Multiplication operator. Returns a vector with scalar multiplied components
    @param[in] s Scalar to multiply by
  ...
  */
  ...
  /*!
    ...
    @return Returns (*this) with incremented compoments, e.g. this->X[0] = this->X[0] + u.X[0]
  */
  inline
  Vec3T<T>& operator+=(const Vec3T<T>& u) noexcept;
  ...
  /*!
    ...
    @return Returns (*this) with subtracted compoments, e.g. this->X[0] = this->X[0] - u.X[0]
  */
  inline
  Vec3T<T>& operator-=(const Vec3T<T>& u) noexcept;
  ...
  /*!
    ...
    @param[in] s Scalar to multiply by
    @return Returns (*this) with multiplied compoments, e.g. this->X[0] = this->X[0] * s
  */
  inline
  ...
  */
  ...
  /*!
    ...
    @param[in] u Other vector
    @return Returns a new vector with X[0] = std::min(this->X[0], u.X[0]) (and same for the other components)
  */
  inline
  Vec3T<T> min(const Vec3T<T>& u) noexcept;

  /*!
    @brief Vector maximum function. Returns a new vector with componentwise maximums.
    @param[in] u Other vector
    @return Returns a new vector with X[0] = std::minmax->X[0], u.X[0]) (and same for the other components)
  */
  inline
  ...
  */
  ...
  /*!
    ...
    @return Returns the vector length, i.e. sqrt(X[0]*X[0] + X[1]*X[1] + Y[0]*Y[0])
  */
  inline
  T length() const noexcept;
  ...
  /*!
    ...
    @return Returns the vector length squared, i.e. (X[0]*X[0] + X[1]*X[1] + Y[0]*Y[0])
  */  
  inline
  T length2() const noexcept;
