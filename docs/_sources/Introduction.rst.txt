...
Originally, it was written to be used used with embedded-boundary (EB) codes like Chombo or AMReX.
...
To obtained EBGeometry, clone the the code from `github <https://github.com/rmrsk/EBGeometry>`_
