\hypertarget{classVec2T}{}\section{Vec2T$<$ T $>$ Class Template Reference}
\label{classVec2T}\index{Vec2\+T$<$ T $>$@{Vec2\+T$<$ T $>$}}
...
\index{Vec2T@{Vec2T}!Vec2T@{Vec2T}}
\subsubsection{\texorpdfstring{Vec2\+T()}{Vec2T()}\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
...
\index{Vec2T@{Vec2T}!dot@{dot}}
\index{dot@{dot}!Vec2T@{Vec2T}}
...
\index{Vec2T@{Vec2T}!length@{length}}
\index{length@{length}!Vec2T@{Vec2T}}
...
\index{Vec2T@{Vec2T}!length2@{length2}}
\index{length2@{length2}!Vec2T@{Vec2T}}
...
\index{Vec2T@{Vec2T}!operator$\ast$@{operator$\ast$}}
\index{operator$\ast$@{operator$\ast$}!Vec2T@{Vec2T}}
